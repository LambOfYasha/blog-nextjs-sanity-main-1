...
const post: Post = await client.fetch(query, {slug})
   return <article>
    <section>
        ...
        <div className="w3-amber w3-center"><Image className="w3-circle w3-border w3-border-black" width={90} height={80} src={urlFor(post.author.picture).url()} alt={post.author.name} /></div>
      ...
      year: "numeric",
            ...
            {!post.categories ? null : post.categories.map((category) => 
