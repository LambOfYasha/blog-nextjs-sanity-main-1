...
<Link href={"https://www.antiblasphemy.studio/projects/zin"} ><Image src={ZINBanner} className='w3-image w3-hide-large w3-hide-medium' alt="ZIN" width="300" height="50" /></Link>
