...
function BlogBox({posts}: Props) {
 ...
 {posts.map((post) => {
  ...
  <article  className='w3-container w3-card w3-margin w3-padding w3-col m7 w3-border w3-border-black w3-amber w3-button w3-round-xlarge'>
     ...
     <div className='w3-black w3-container w3-padding w3-tiny'>{post.title}</div>
